...
<head>
    ...
    <title>L'Éclat du Bénin — Rejoindre les Artisans</title>
            ...
            theme: {
                extend: {
                    colors: {
                        ...
                        "surface-container-lowest": "#ffffff", "on-background": "#1a1c1a",
                        "background": "#faf9f6", "on-surface": "#1a1c1a",
                        "secondary-fixed": "#ffe088", "secondary-container": "#fed65b",
                        "outline-variant": "#c4c7c7", "inverse-surface": "#2f312f",
                        "error-container": "#ffdad6", "surface-variant": "#e3e2e0",
                        "surface": "#faf9f6", "primary-container": "#1c1b1b",
                        "on-secondary": "#ffffff", "on-primary-container": "#858383",
                        "secondary": "#735c00", "error": "#ba1a1a",
                        "surface-bright": "#faf9f6", "on-primary": "#ffffff",
                        "on-error": "#ffffff",
                    },
                    borderRadius: { "DEFAULT": "0.125rem", "lg": "0.25rem", "xl": "0.5rem", "full": "0.75rem" },
                    spacing: { "margin-desktop": "80px", "container-max": "1280px", "margin-tablet": "40px", "gutter": "24px", "margin-mobile": "20px" },
                    fontFamily: { "label-caps": ["Montserrat"], "display-lg": ["Playfair Display"], "body-md": ["Montserrat"], "body-lg": ["Montserrat"], "headline-md": ["Playfair Display"], "headline-lg": ["Playfair Display"] },
                    fontSize: {
    ...
    <style>
        ...
        #strength-bar div { transition: width 0.4s ease; }
    </style>
</head>
...
<header class="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl border-b border-outline-variant/30 flex justify-between items-center px-gutter py-4">
    ...
    <div class="font-headline-md text-headline-md font-bold text-primary uppercase tracking-widest">
        L'ÉCLAT DU BÉNIN
    </div>
...
{{-- ===== FOOTER ===== --}}
<footer class="w-full bg-surface-container-lowest border-t border-outline-variant/50 py-12 px-margin-desktop">
...
passwordInput.addEventListener('input', function() {
    ...
    const levels = [
        { pct: '25%',  color: '#ba1a1a', label: 'Très faible' },
        { pct: '50%',  color: '#e6a817', label: 'Faible' },
        { pct: '75%',  color: '#735c00', label: 'Bon' },
        { pct: '100%', color: '#1a7a4a', label: 'Excellent' },
    ];
