...
<head>
    ...
    <title>Inscription | L'Éclat du Bénin</title>
...
<main class="flex-grow flex items-center justify-center px-6 pb-20">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-10">
            <h1 class="font-display-lg-mobile text-display-lg-mobile text-primary mb-3">Créer un compte client</h1>
            <p class="text-sm text-on-surface-variant">Inscrivez-vous pour découvrir et acheter des pièces uniques.</p>
        </div>
        ...
        <form action="{{ route('register.store') }}" method="POST" class="space-y-8" id="login-form">
            @csrf

            <div class="float-label-group">
                <input type="name" id="name" name="name" placeholder=" " value="{{ old('name') }}" autocomplete="name" />
            ...
            <div class="float-label-group">
                <input type="password" id="password" name="password_confirmation" placeholder=" " autocomplete="current-password" />
            ...
            <button type="submit" id="submit-btn"
                ...
                <span id="btn-text">Créer mon compte client</span>
        ...
        <p class="text-center text-sm text-on-surface-variant mt-8">
            Déjà un compte ?
            <a href="{{ route('login') }}" class="text-secondary font-semibold hover:text-primary transition-colors">Connectez-vous</a>
        </p>
    </div>
</main>
