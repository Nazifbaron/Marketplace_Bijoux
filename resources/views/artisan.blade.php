...
<body class="bg-background text-on-background font-body-md selection:bg-secondary-container">
    ...
    <main class="pt-32 pb-section-gap max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-gutter gap-y-20">
            ...
            <article class="vendor-card group cursor-pointer md:mt-24">
                <div class="relative aspect-[4/5] overflow-hidden bg-surface-container mb-6">
                    <img alt="Maison de la Céramique" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="A minimalist pottery studio with rows of unglazed ivory ceramic vessels resting on raw concrete shelves. A single terracotta vase sits on a potter's wheel in the center, catching a sliver of warm light. The aesthetic is clean, Zen-like, and sophisticated, focusing on form and the natural beauty of the earth-toned materials." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCbf2M6vu2iGwiMkp4kGt8g-nsc4IEGU4p0Qr2t41bKVuTpzpihj5q9ES2L5OdHZNAPrjnqVYHmE3SEkFyPhfHTy0hi47o4XgMSjHNMmexuiIY4vO1eYEr-jqICTf5mvjMWDYt183kzaZU-EoK07gx-pR6wOO8dtES8Td3SjFhx0rovVoNYLNF8qpF9Il9kziHrRHgvCC27Q8ttFpCs5xPpYXpyKEZGnXhl4SOqJyjQ5BlMOZrYeBcwIEp_DrhwA90q3l6Dy3hjhA" />
                    <div class="quick-view-btn absolute bottom-0 left-0 w-full p-6 opacity-0 translate-y-4 transition-all duration-300">
                        <button class="w-full bg-primary text-on-primary py-4 font-label-caps text-label-caps uppercase tracking-widest hover:bg-on-primary-fixed transition-colors">Entrez dans l'atelier</button>
                    </div>
                </div>
            ...
            <article class="vendor-card group cursor-pointer">
                <div class="relative aspect-[4/5] overflow-hidden bg-surface-container mb-6">
                    <img alt="L'Art du Fer" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="An artistic forge where glowing red iron is being shaped into an elegant ornamental gate. Sparks fly in slow motion against a dark, moody background. The scene is industrial yet luxurious, highlighting the raw power of fire and the delicate precision of the blacksmith's art, punctuated by the amber glow of the furnace." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBSTKh9QuzbikdQ4S8P8mZ-sAQMpk18qZEdNQ0SpiqmNAXoCvO5qVYX1J192B8Bzpa7Lyl38TXQJ5hVorLaX-CumPG6lSYqGpRJUizrTswF8l6a3aJBNXw6MZ8HakmuvPb-Nw_YGMYNcTzp8DtTSS-_Xp3s440kSc5MJRlNUaHryDq4t-sYrmwVEtuBOF6B7Qojm7IVkX7TzYqQudnXpvulttERIOc_DJsmIKr2ROuLxVMu-wu80bEwN-Os1MVAIOYhBFPUCD7uEg" />
                    <div class="quick-view-btn absolute bottom-0 left-0 w-full p-6 opacity-0 translate-y-4 transition-all duration-300">
                        <button class="w-full bg-primary text-on-primary py-4 font-label-caps text-label-caps uppercase tracking-widest hover:bg-on-primary-fixed transition-colors">Entrez dans l'atelier</button>
                    </div>
                </div>
